...
class XML
{
    //cambie la visibilidad de los atributos para poder acceder a ellos
    private $atributos;
    protected $rules;
    ...
    //cambie los métodos a public para poder usar dentro la clase principal
    ...
    {
        //quite la validacion por que no permitia setear el campo de TipoDeComprobante, asi setea
        //echo(">>".$attr.":".$value);
        $this->atributos[] = $this->atributos[$attr]=$this->setSatFormat($value);
    ...
    public function getAtributes()
    {
        ...
        foreach ($this->atributos as $key => $value) :
            ...
            //echo(">>>".$key);
            //agregue esta validación porque me tiraba un error al agregar índices de tipo entero y al pasar por la validación no permite terminar el proceso
            if(!is_int($key)) {
